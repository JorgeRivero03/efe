<%-- 
    Document   : consumoA
    Created on : 16-jun-2021, 16:32:26
    Author     : bailarina77
--%>
...
<html>
    <head>
        ...
        <body>
            ...
            <form action="../../registrarConsumoY" class="formulario__cigarro">
                            ...
                            <label for="sexo" class="formulario__label">Sexo</label>
                                <div class="select">
                                  <select name="slct2" id="slct2" >
                                    <option value="1">Shot 45 ml</option>
                                    <option value="2">Botella 210ml</option>
                                    <option value="3">Botella 375 ml</option>
                                    <option value="4">Botella 750 ml </option>
                                    <option value="5">Botella 940 ml </option>
