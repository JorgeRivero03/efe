...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.usuario && campos.nombre && campos.appe && campos.password && campos.edad && campos.correo){


	}  else {
			if(campos.usuario==false || campos.nombre==false || campos.appe==false || campos.password==false || campos.edad==false || campos.correo==false){
